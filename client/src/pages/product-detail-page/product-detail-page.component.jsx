  ...
  return(
      ...
      productDetail ? (
        ...
        >
            ...
            <Tabs defaultActiveKey="1" centered style={{
              padding: "0 20% 5%",
              color: '#777777'
              ...
              backgroundColor:'#f9fafc'
                ...
                <TabPane  tab={<div className="tabPaneHeading">Description</div>} key="1">
                  ...
                  <p>
                    ...
                    ‘Hangover’ by Beryl’s husband and still hangs in their house today
                  </p>
                  <p>
                    ...
                    more efficient for one person creating less waste. The mission
                  </p>
                  </div>
                </TabPane>
                <TabPane tab={<div className="tabPaneHeading">Specification</div>} key="2">
                ...
                <div className="single-row">
                  ...
                  <div className="single-row">
                    <span>Amount</span>
                    <span>{productDetail.amount}mm</span>
                  </div>
                  <div className="single-row">
                    <span>Weight</span>
