    ...
    <>
        <div className="header-top">
            ...
            <div className="ht-left">
                ...
                <PhoneOutlined style={{marginRight: '0.5rem',color:'#252525'}}/>
                + 84 983 866 14
                </div>
            </div>
            <div className="ht-right">
                {
                    !currentUser ? 
                            <Link to="/signInSignUp" className="login-panel">
                                <UserOutlined style={{marginRight: '0.8rem',color:'#252525'}} />
                                Login
                            </Link>
                            : (
                                <>
                                <Link to="/signInSignUp" onClick={() =>signOut()} className="login-panel logout">
                                        LOG OUT 
                                </Link>
                ...
                <div className="top-social">
                    <a href="https://www.facebook.com/hthuongh1939203" target="blank"><i className="fa fa-facebook"></i></a>
                    <a href="https://www.instagram.com/cownnut/" target="blank"><i className="fa fa-twitter"></i></a>    
                </div>
            </div>
            </div>
        </div>
