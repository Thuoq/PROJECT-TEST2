...
const mapDispatchToProps = dispatch => ({
  getCollectionStart : searchFiled => dispatch(getCollectionStart(searchFiled))
})
...
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(NavigationSearch));
